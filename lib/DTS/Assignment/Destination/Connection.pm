package DTS::Assignment::Destination::Connection;

=head1 NAME

DTS::Assignment::Destination::Connection - a subclass of DTS::Assignment::Destination for connections
...
C<DTS::Assignment::Destination::Connection> is a subclass of C<DTS::Assignment::Destination> and represents the 

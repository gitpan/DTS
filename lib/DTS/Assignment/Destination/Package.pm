package DTS::Assignment::Destination::Package;

=head1 NAME

DTS::Assignment::Destination::Package - a subclass of DTS::Assignment::Destination for a package
...
C<DTS::Assignment::Destination::Package> is a subclass of C<DTS::Assignment::Destination> and represents the 
